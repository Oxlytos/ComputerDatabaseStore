...
{
    /// <inheritdoc />
    public partial class NewInitalCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllComponentSpecifcations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompuerProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompuerProducts_BrandManufacturers_BrandId",
                        column: x => x.BrandId,
                        principalTable: "BrandManufacturers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CompuerProducts_ComponentCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasketProducts_CompuerProducts_ComputerPartId",
                        column: x => x.ComputerPartId,
                        principalTable: "CompuerProducts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    State_Or_County_Or_Province = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerShippingInfos", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryProviderId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderedProducts_CompuerProducts_ComputerPartId",
                        column: x => x.ComputerPartId,
                        principalTable: "CompuerProducts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketProducts_ComputerPartId",
                table: "BasketProducts",
                column: "ComputerPartId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketProducts_CustomerId_ComputerPartId",
                table: "BasketProducts",
                columns: new[] { "CustomerId", "ComputerPartId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompuerProducts_BrandId",
                table: "CompuerProducts",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_CompuerProducts_CategoryId",
                table: "CompuerProducts",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderedProducts_ComputerPartId",
